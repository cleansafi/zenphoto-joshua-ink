   ...
   <?php
	...
	<div id="foot">
		<div id="logo">
			...
			alt="ZenPhoto logo" width="90" height="24"
			/></a>
		</div>

		<div id="options">
<?php	if (zp_loggedin()) { ?>
			<a href="<?php echo WEBPATH.'/zen/admin.php'; ?>">Admin</a> |
			<a href="<?php echo WEBPATH.'/zen/admin.php?page=edit'; ?>"
				alt="Sort the Gallery">Sort Gallery</a> |
			<a href="?logout" title="Logout of ZenPhoto">Logout</a>
<?php	} else { ?>
			<a href="<?php echo WEBPATH.'/zen/admin.php'; ?>">Login</a>
<?php } ?>
		</div>
		...
		<div id="info">
			...
			ZenPhoto <?php echo zp_conf('version') . "\n"; ?>
		</div>
	</div>
